...
<div style="background:#DBA39A; height:60" class="container-fluid">
  <div class="container">
  <div class="breedcump  py-3">
    <span class="text-white">Home / Portflio</span>
  </div>

  <h1 class="h1  font-weight-bold mt-4">Porfolio Kami</h1>
  <p class="lead">
    Berikut beberapa desain yang telah kami kerjakan
  </p>
  <div class="row">
...
<<<<<<< HEAD
               <img class="img-fluid" src="<?= base_url()?>assets/images/gallery/browsur2.png" alt="">
=======
               <img class="img-fluid" src="<?= base_url()?>assets/images/gallery/our-gallery-2.jpg" alt="">
>>>>>>> a74616de816d834fc780f6cd389c02eb507b6e6a
               </a>
            </div>
            <div class="item gts col-lg-3 col-md-4 col-6 col-sm">
               ...
               <img class="img-fluid" src="<?= base_url()?>assets/images/gallery/logo.png" alt="">
               </a>
            </div>
            <div class="item selfie col-lg-3 col-md-4 col-6 col-sm">
               ...
               <img class="img-fluid" src="<?= base_url()?>assets/images/gallery/browsur.png" alt="">
               </a>
            </div>
            <div class="item gts col-lg-3 col-md-4 col-6 col-sm">
               ...
               <img class="img-fluid" src="<?= base_url()?>assets/images/gallery/logo3.png" alt="">
               </a>
            </div>
            <div class="item gts col-lg-3 col-md-4 col-6 col-sm">
               ...
               <img class="img-fluid" src="<?= base_url()?>assets/images/gallery/poster-merah.jpg" alt="">
               </a>
            </div>
            <div class="item gts col-lg-3 col-md-4 col-6 col-sm">
               ...
               <img class="img-fluid" src="<?= base_url()?>assets/images/gallery/logo2.png" alt="">
               </a>
            </div>
            <div class="item lap col-lg-3 col-md-4 col-6 col-sm">
               ...
               <img class="img-fluid" src="<?= base_url()?>assets/images/gallery/browsur1.png" alt="">
               </a>
            </div>
            <div class="item lap col-lg-3 col-md-4 col-6 col-sm">
               ...
               <img class="img-fluid" src="<?= base_url()?>assets/images/gallery/poster1.png" alt="">
               </a>
            </div>
            <div class="item gts col-lg-3 col-md-4 col-6 col-sm">
               ...
               <img class="img-fluid" src="<?= base_url()?>assets/images/gallery/logo-cantik.jpg" alt="">
               </a>
            </div>
            <div class="item lap col-lg-3 col-md-4 col-6 col-sm">
               ...
               <img class="img-fluid" src="<?= base_url()?>assets/images/gallery/1.jpeg" alt="">
               </a>
            </div>
            <div class="item gts col-lg-3 col-md-4 col-6 col-sm">
               ...
               <img class="img-fluid" src="<?= base_url()?>assets/images/gallery/3.jpg" alt="">
               </a>
            </div>
            <div class="item gts col-lg-3 col-md-4 col-6 col-sm">
               ...
               <img class="img-fluid" src="<?= base_url()?>assets/images/gallery/cofe.jpg" alt="">
               </a>
            </div>
            <div class="item gts col-lg-3 col-md-4 col-6 col-sm">
               <a href="https://image.freepik.com/free-photo/girl-city_1157-16454.jpg" class="fancylight popup-btn" data-fancybox-group="light">
               <img class="img-fluid" src="<?= base_url()?>assets/images/gallery/2.jpg" alt="">
               </a>
            </div>
            <div class="item gts col-lg-3 col-md-4 col-6 col-sm">
               ...
               <img class="img-fluid" src="<?= base_url()?>assets/images/gallery/4.jpg" alt="">
               </a>
            </div>
            <div class="item lap col-lg-3 col-md-4 col-6 col-sm">
               ...
               <img class="img-fluid" src="<?= base_url()?>assets/images/gallery/13.jpg" alt="">
               </a>
            </div>
            <div class="item gts col-lg-3 col-md-4 col-6 col-sm">
               ...
               <img class="img-fluid" src="<?= base_url()?>assets/images/gallery/7.jpg" alt="">
               </a>
            </div>
            <div class="item gts col-lg-3 col-md-4 col-6 col-sm">
               ...
               <img class="img-fluid" src="<?= base_url()?>assets/images/gallery/8.jpg" alt="">
               </a>
            </div>
            <div class="item selfie col-lg-3 col-md-4 col-6 col-sm">
               ...
               <img class="img-fluid" src="<?= base_url()?>assets/images/gallery/5.jpg" alt="">
               </a>
            </div>
            <div class="item selfie col-lg-3 col-md-4 col-6 col-sm">
               ...
               <img class="img-fluid" src="<?= base_url()?>assets/images/gallery/10.jpg" alt="">
               </a>
            </div>
            <div class="item selfie col-lg-3 col-md-4 col-6 col-sm">
               ...
               <img class="img-fluid" src="<?= base_url()?>assets/images/gallery/6.jpg" alt="">
               </a>
            </div>
            <div class="item lap col-lg-3 col-md-4 col-6 col-sm">
               ...
               <img class="img-fluid" src="<?= base_url()?>assets/images/gallery/14.jpg" alt="">
               </a>
            </div>
            <div class="item lap col-lg-3 col-md-4 col-6 col-sm">
               ...
               <img class="img-fluid" src="<?= base_url()?>assets/images/gallery/15.jpg" alt="">
               </a>
            </div>
            <div class="item lap col-lg-3 col-md-4 col-6 col-sm">
               ...
               <img class="img-fluid" src="<?= base_url()?>assets/images/gallery/16.jpg" alt="">
               </a>
            </div>
            <div class="item gts col-lg-3 col-md-4 col-6 col-sm">
               ...
               <img class="img-fluid" src="<?= base_url()?>assets/images/gallery/17.jpg" alt="">
               </a>
            </div>
