        ...
        <div class="row">
          ...
          <div class="col-md-12">
            <div class="col-md-12 col-lg-12">
              <div class="h-entry">
                <center>
                  <?php if ($id_transaksi <= 4): ?>
                    <a class="example-image-link" href="<?=base_url($ket->img)?>" data-lightbox="example-set" ><img class="example-image" src="<?=base_url($ket->img)?>" width="240px" height="240px" alt=""/></a>
                  <?php else: ?>
                  ...
                  <?php endif ?>
                  <div class="meta mb-4"><span class="mx-2"></span><b><?=$kategori?></b> / Upload &bullet; <?=$value->tanggal_upload?><span class="mx-2">&bullet;</span> <br><b>Harga Per Desain</b> : Rp. <?=number_format($ket->harga)?><br><b>Status</b> : <b><i><?=$status?></i></b></div>
                </center>
              </div> 
            </div>
          </div> 
              ...
              <div id="myDIV" style="display: none;">
                ...
                <!-- <div class="row form-group">
                  <div class="col-md-12">
                    ...
                    <input type="text" class="form-control" value="<?=$ket_pembelian->panjang_kertas?>" disabled>
                  </div>
                </div>   -->
                <?php endif ?>
                <?php if ($value->kategori == 3): ?>
